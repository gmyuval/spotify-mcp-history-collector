.PHONY: setup lock lock-check validate-uv agent-contract lint format typecheck precommit \
...
check: lock-check validate-uv agent-contract lint typecheck precommit test docker-lock-check compose-config
