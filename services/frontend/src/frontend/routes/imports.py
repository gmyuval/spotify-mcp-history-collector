"""Import jobs page — class-based router for list, upload, and status."""
...
class ImportsRouter:
    """Class-based router for import jobs pages."""

    def __init__(self) -> None:
        self.router = APIRouter()
        self.router.add_api_route("/", self.list_imports, methods=["GET"], response_class=HTMLResponse)
        self.router.add_api_route(
            "/partials/imports-table", self.imports_table_partial, methods=["GET"], response_class=HTMLResponse
        )
        self.router.add_api_route("/upload", self.upload_import, methods=["POST"], response_class=HTMLResponse)

    async def list_imports(self, request: Request) -> HTMLResponse:
    ...
    async def imports_table_partial(self, request: Request) -> HTMLResponse:
    ...
    async def upload_import(self, request: Request) -> HTMLResponse:
