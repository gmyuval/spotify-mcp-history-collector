...
The current branch collects 873 package tests plus the dependency-free contract suite. The
...
| API | 627 (620 unit + 7 integration) | `uv run --locked pytest services/api/tests/` |
...
| **All package suites** | **873** | `make test` |
