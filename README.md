...
The current branch collects 878 package tests plus the dependency-free contract suite. The
...
| API | 632 (625 unit + 7 integration) | `uv run --locked pytest services/api/tests/` |
...
| **All package suites** | **878** | `make test` |
